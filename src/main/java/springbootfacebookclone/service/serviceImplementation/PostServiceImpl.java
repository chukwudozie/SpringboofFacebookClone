...
public class PostServiceImpl implements PostService {
    ...
    @Autowired
    public PostServiceImpl(PostRepository postRepository, LikesRepository likesRepository,
            CommentRepository commentRepository, PersonRepository personRepository) {
